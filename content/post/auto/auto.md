...
### 错误1：证明器不存在
<img src="./auto.assets/error1/error1.png" width="80%" align="center" /><br>
检查dist文件夹下有没有这个cprover_priority<br>
<img src="./auto.assets/error1/solve1.png" width="80%" align="center" /><br>
 若没有那就把cse 改成这个名字，然后再添加可执行权限<br>
 <img src="./auto.assets/error1/solve2.png" width="80%" align="center" /><br>
 ### 错误2：判定异常
...
**解决方法：**
重装ubuntu系统<br>
<img src="./auto.assets/error4/error4.png" width="80%" align="center" /><br>