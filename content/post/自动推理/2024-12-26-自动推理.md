...
### 错误1：证明器不存在
<img src="./自动推理.assets/错误1/错误1.png" width="50%" align="center" />
检查dist文件夹下有没有这个cprover_priority
<img src="./自动推理.assets/错误1/解决1.png" width="50%" align="center" />
 若没有那就把cse 改成这个名字，然后再添加可执行权限
 <img src="./自动推理.assets/错误1/解决2.png" width="50%" align="center" />
 ### 错误2：判定异常
...
**解决方法：**
重装ubuntu系统
 <img src="./自动推理.assets/错误4/错误4.png" width="50%" align="center" />